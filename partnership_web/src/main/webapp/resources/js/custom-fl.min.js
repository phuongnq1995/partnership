    ...
    e(document).ready(function() {
        function t() {
            ...
            t < 973 ? (e("#navigation").removeClass("menu"), e("#navigation li").removeClass("dropdown"), e("header#main-header").removeClass("full-width"), e("#navigation").superfish("destroy")) : (e("#navigation").addClass("menu"), "yes" === e("header#main-header").data("full") && e("header#main-header").addClass("full-width"), e("#navigation").superfish({
                ...
                speed: 200,
                speedOut: 50
            })), t < 1290 ? e("header#main-header").addClass("alternative").removeClass("full-width") : "yes" === e("header#main-header").data("alt") || e("header#main-header").removeClass("alternative")
        }
        ...
        if (0 === b.length || (e(".tab-content").hide(), b.trigger("click"), e(g + ".tab-content").show()), e("#login-tabs a").click(function(t) {
            ...
            e(".sticky-header").clone(!0).addClass("cloned").insertAfter(".sticky-header"), e(".sticky-header.cloned.alternative").removeClass("alternative"), e(".sticky-header.cloned .popup-with-zoom-anim").magnificPopup({
                type: "inline",
                fixedContentPos: !1,
                fixedBgPos: !0,
                overflowY: "auto",
